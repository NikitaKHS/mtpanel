...
3. Скачивает бинарник панели из релиза.
4. Пишет конфиг в `/etc/mtpanel/config.json`.
5. Устанавливает и запускает `mtpanel.service`.
6. Показывает URL панели и начальный пароль.
